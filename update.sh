...
res1() {
   cd
    wget https://raw.githubusercontent.com/gyrogerald/insshx/main/Cdy/menu.zip
    ...
    wget /usr/local/sbin "https://raw.githubusercontent.com/gyrogerald/insshx/main/Cfg/m-noobz" 
